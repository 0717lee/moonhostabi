...
try {
  ...
  $helpText = @(
    ...
    '  moonhostabi resource-lock-v4 <artifact.wasm> --out <resource-lock-v4.json>',
    '  moonhostabi resource-contract <artifact.wasm> --out <resource-contract.json>',
    '  moonhostabi resource-verify <artifact.wasm> --against <resource-lock.json> --format <json|text|markdown>',
    ...
    '  moonhostabi generate <artifact.wasm> [--contract <contract.json>] --resource-contract <resource-contract.json> --out <directory>',
    '  moonhostabi --help',
    '  moonhostabi --version'
  ) -join "`n"
